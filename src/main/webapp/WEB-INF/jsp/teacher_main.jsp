...
<head>
    ...
    window.onload=function(){
    	showcontent('欢迎访问','${pageContext.request.contextPath }/teacher_welcome');
    }
...
<div id="nav-menu" data-options="region:'west',split:true,title:'菜单导航'">
    <div class="easyui-accordion" fit="true" border="false">
        <div title="基本功能" data-options="iconCls:'icon-mini-add'" style="overflow:auto">
            ...
            <div><a onclick="showcontent('学生基本信息管理','${pageContext.request.contextPath }/tea_adn_student_info')">学生基本信息管理</a></div>
            <div><a onclick="showcontent('学生奖惩信息管理','${pageContext.request.contextPath }/tea_adn_student_jc')">学生奖惩信息管理</a></div>
            <div><a id="cj_onclick" onclick="cj(${user.zhuanye_id})">学生成绩管理</a></div>
            <div><a onclick="showcontent('综合测评管理','${pageContext.request.contextPath }/tea_adn_student_ccj')">综合测评管理</a></div>
            </li></ul>
        </div>
