...
function doView() {
	...
	$(function(){
		...
		$('#grid').datagrid( {
			...
			striped : true,
			toolbar : toolbar,
			url : "${pageContext.request.contextPath}/adminqueryStudentJcList",
	...
	function openAddDialog() {
	    ...
	    $("#jiangcheng_id").removeAttr("name");
	      url = "${pageContext.request.contextPath}/adminaddStudentJc";
	}
	//修改学生jc信息
	function openModifyDialog() {
	    ...
	    $("#fm").form("load", row);
	    url = "${pageContext.request.contextPath}/adminmodifyStudentJc";
	}
	//新增与修改的统一按钮
	...
	$.messager.confirm("系统提示", "您确定要删除这<font color=red>"
	    ...
	    if (r) {
	        $.post("${pageContext.request.contextPath}/admindeleteStudentJc", {
	            ids : ids
	        }, function(result) {
	            if (result) {
